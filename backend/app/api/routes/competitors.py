...
def create_competitor(
    ...
    return create_competitor_for_user(db, user=current_user, payload=payload)
...
def list_competitors(
    ...
    return list_competitors_for_user(db, user=current_user)
...
def delete_competitor(
    ...
    delete_competitor_for_user(db, user=current_user, competitor_id=competitor_id)
