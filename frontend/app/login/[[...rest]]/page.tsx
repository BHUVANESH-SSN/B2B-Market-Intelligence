...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      const core = ctx.createRadialGradient(glow.x, glow.y, 0, glow.x, glow.y, 90);
    ...
    >
      ...
      <div className="relative z-10 hidden w-1/2 flex-col justify-center px-16 md:flex">
        ...
        <p className="mt-6 max-w-md text-lg text-slate-300">
          Sign in to continue tracking competitors, pricing shifts, and market
          momentum from one focused workspace.
        </p>
      </div>
